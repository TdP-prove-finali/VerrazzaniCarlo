...
public class SimulatorDay2 {
	//parametri di ingresso
			...
			public SimulatorDay2(List<MatchDoppio> calendarioDay2) {
			...
			public SimResult getRisultato() {
				...
				List<MatchDoppio>risultatiDay1 = new ArrayList<>(this.risultatiDay2);
				SimResult res = new SimResult(punteggioEUR, punteggioUSA, null, risultatiDay2, null);
				return res;
			}
}
